...
public class BrowserActions {
    ...
    public static void waitUntilWebElementIsPresent(By element,WebDriver driver) throws Exception {
        waitUntilLoaderElementIsNotDisplayed(driver);
    ...
    public static void waitAndSelectFromDropdown(String value,By element,WebDriver driver) throws Exception {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println(e.getMessage());
            throw new Exception("Can not select option from dropdown: "+element.toString(),e);
        }
    }
    ...
    public static void waitUntilLoaderElementIsNotDisplayed(WebDriver driver) throws Exception {
        By loaderElement1 =By.xpath("//div[@class='overlay ng-tns-c12-0 ng-trigger ng-trigger-fadeIn ng-star-inserted']");
        By loaderElement2 =By.xpath("//ngx-spinner[@type='ball-atom']");
        BrowserActions.waitUntilWebElementIsNotPresent(loaderElement1,driver);
        BrowserActions.waitUntilWebElementIsNotPresent(loaderElement2,driver);
    }
